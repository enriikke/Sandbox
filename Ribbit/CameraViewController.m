...
- (void)viewDidLoad
{
    ...
    [self setRecipients:[[NSMutableArray alloc] init]];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if ([mediaType isEqualToString:(NSString *)kUTTypeImage]) {
        ...
        [self setVideoFilePath:[[info objectForKey:UIImagePickerControllerMediaURL] path]];
...
- (void)uploadMessage {
    ...
    [file saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        if (error) {
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Error ocurred!"
